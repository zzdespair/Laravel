                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="layui-form" action="">
                                        <div class="layui-form-item remmend" style="margin:0;">
                                            <input type="checkbox" class="check" name="arremmend" title="推荐" lay-filter="top" @if($item->arremmend == 2) checked @endif>
                                            <input type="hidden" name="id" value="{{$item->arid}}">
                                        </div>
                                    </form>
                                </td>
                                <td>
                                    <a href="{{route('article.edit',$item->arid)}}">
                                ...
                                <td>
                                    <a href="{{action('Admin\ArticleController@recycle',['id'=>$item->arid,'recycle'=>$item->arstatus])}}" class="recycle">
                                        <button class="layui-btn layui-btn-small layui-btn-danger" title="加入回收站"><i class="layui-icon">&#xe640;</i></button>
                                    </a>
                                </td>
                            </tr>
                        @endforeach
