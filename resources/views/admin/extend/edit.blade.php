    ...
    {{ csrf_field() }}
        ...
        <div class="layui-upload" style="margin-left:7%;">
            ...
            <div class="layui-upload-list">
                <img class="layui-upload-img" @if($links->lilogo) src="http://qiniu.zhuxv.com/{{$links->lilogo}}" @endif id="imgShow" style="width:200px;">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">友链名称</label>
            <div class="layui-input-block">
              <input type="text" name="liname" lay-verify="title" autocomplete="on" placeholder="请输入友链名称" class="layui-input" style="width:50%;" value="{{$links->liname}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">友链链接</label>
            <div class="layui-input-block">
              <input type="text" name="lilink" lay-verify="title" autocomplete="on" placeholder="示例:http://blog.zhuxv.com" class="layui-input" style="width:50%;" id="linkes" value="{{$links->lilink}}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">状态</label>
            <div class="layui-input-block">
                <input type="checkbox" @if($links->listatus == 1) checked @endif name="listatus" lay-skin="switch" lay-filter="switchTest" lay-text="启用|禁用">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
    ...
    <script>
        $(function(){
            $("#btn").click(function(){
                ...
                $.ajax({
                    url:"{{action('Admin\ExtendController@update',['id'=>$links->liid])}}",
                    type:'post',
                    data:formData,
                    dataType: 'json',
                    async:true,
